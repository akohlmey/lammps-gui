...
*only* enabled by default when compiling LAMMPS-GUI for Qt 6.10 and later
*and* when the QtCharts module is not available.  Setting
``-D LAMMPS_GUI_USE_QTCHARTS=no`` will enforce using the QtGraphs based
chart display.
