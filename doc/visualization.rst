...
Starting with the 11 Feb 2026 version of LAMMPS, is is possible for
...
With the "Visualize Compute and Fix Graphics Objects" dialog these
objects can be enabled and its settings adjusted.  The dialog can
be opened by either pressing the "Computes and Fixes" button or using the
